...
namespace ERP.Entities.Request
{
    public class MISTallyRequest
    {
        ...
        [JsonProperty(PropertyName = "totalexpensesamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalExpensesAmt { get; set; }

        [JsonProperty(PropertyName = "totalsalesaccountamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalSalesAccountAmt { get; set; }

        [JsonProperty(PropertyName = "totaldirectincomeamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalDirectIncomeAmt { get; set; }

        [JsonProperty(PropertyName = "totalindirectincomeamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalIndirectIncomeAmt { get; set; }

        [JsonProperty(PropertyName = "totaldirectexpensesamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalDirectExpensesAmt { get; set; }

        [JsonProperty(PropertyName = "totalemployeescostamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalEmployeesCostAmt { get; set; }

        [JsonProperty(PropertyName = "totalindirectexpensesamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalIndirectExpensesAmt { get; set; }

        [JsonProperty(PropertyName = "totalbusinesspromotionamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalBusinessPromotionAmt { get; set; }

        [JsonProperty(PropertyName = "totalinterestexpensesamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalInterestExpensesAmt { get; set; }

        [JsonProperty(PropertyName = "totalsalaryperquisitestomdamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalSalaryPerquisitesToMdAmt { get; set; }

        [JsonProperty(PropertyName = "totalprofitamt", DefaultValueHandling = DefaultValueHandling.Ignore)]
        public double TotalProfitAmt { get; set; }
        #endregion
